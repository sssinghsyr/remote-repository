...
namespace NoSqlDb
{
  ...
  */
  inline void showHeader(bool showKey = true, std::ostream& out = std::cout)
  {
    ...
    out << std::setw(12) << std::left << "DateTime";
    out << std::setw(20) << std::left << "Description";
    out << std::setw(60) << std::left << "Payload";
    out << "\n  ";
    if(showKey)
  ...
  {
    out << "\n  ";
    out << std::setw(30) << std::left << el.name().substr(0, 13);
    out << std::setw(26) << std::left << std::string(el.dateTime());
    out << std::setw(20) << std::left << el.descrip().substr(0, 18);
    out << std::setw(60) << std::left << std::string(el.payLoad()).substr(0, 58);
  ...
  {
    out << "\n  ";
    out << std::setw(30) << std::left << key.substr(0, 30);
    out << std::setw(20) << std::left << el.name().substr(0, 20);
    out << std::setw(12) << std::left << std::string(el.dateTime()).substr(0, 10);
    out << std::setw(20) << std::left << el.descrip().substr(0, 18);
    out << std::setw(60) << std::left << std::string(el.payLoad()).substr(0, 58);
    Children children = el.children();
    if (children.size() > 0)
